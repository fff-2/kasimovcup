...
아두이노 나노 2대로 동작하는 완전 자율 배틀로봇 펌웨어.
`main_nano/` = 메인(모든 연산) · `color_nano/` = 뒤쪽 컬러센서 전담 · 라이브러리 설치 불필요 (TCS34725 드라이버 내장).
...
| 내부 배치 | 하부 — 컬러센서 앞·뒤 | 외형 — 전면 웨지 |
|---|---|---|
| ![내부 배치: 나노, L298N, 18650 배터리, 모터](docs/media/design-internal.png) | ![하부: 앞뒤 TCS34725 컬러센서](docs/media/design-bottom.png) | ![외형: 전면 경사면](docs/media/design-shell.png) |
...
상태머신 전체(12개 상태·전이 다이어그램)와 전술 설명은 [팀 가이드](https://fff-2.github.io/kasimovcup/#fsm)에 있습니다.
